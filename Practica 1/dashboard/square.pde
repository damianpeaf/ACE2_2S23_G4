...
void setupSquare(float x, float y, float size) {
  ...
  drawSquare(numDrops, drops, numSquares, squares);
}

void drawSquare(int numDrops, Drop[] drops, int numSquares, Square[] squares) {
